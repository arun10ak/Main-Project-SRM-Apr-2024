...
def generate_medical_report(predicted_label):
    ...
    skin_disease_info = {
        "Actinic keratoses": {
            "report": "It appears the patient may have actinic keratoses, which are precancerous skin lesions caused by sun damage. Early treatment is crucial to prevent progression to skin diseases.",
        ...
        "Basal cell carcinoma": {
            "report": "The patient may be showing signs of basal cell carcinoma, the most common form of skin diseases. Early detection and treatment are crucial for a good prognosis.",
            "preventative_measures": [
        ...
        "Melanoma": {
            "report": "There are indications of melanoma, the most serious form of skin disease (cancer). Immediate medical attention and further evaluation are necessary for proper diagnosis and treatment.",
            "preventative_measures": [
...
def render_dashboard(user_info, json_file_path="data.json"):
    ...
    <div style='text-align: left;'>
        <p>There are 7 different classes of skin diseases which are listed below:</p>
        <ul>
